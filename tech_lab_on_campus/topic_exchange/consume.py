...
def main(
    sector: str, queue_name: str  # pylint: disable=unused-argument
) -> None:
    ...
    consumer = mqConsumer(
        binding_key=binding_key,  # pylint: disable=undefined-variable
...
if __name__ == "__main__":
    ...
    sys.exit(main(sector, queue))  # pylint: disable=undefined-variable
