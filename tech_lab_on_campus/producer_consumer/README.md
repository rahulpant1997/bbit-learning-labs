...
- Each contributor should then [git push](../resources/git_commands.md#commands-youll-need-for-today) their solutions to the fork.
- Lastly, follow the `testing instructions below` to send and recieve a message to complete this section.

   
**IMPORTANT!!!** Please use the [functions.md](../resources/functions.md) file as it contains almost all the functions you will need for this lab. Also, other helpful information can be found under the resources folder for Python, Git, and RabbitMQ details.
