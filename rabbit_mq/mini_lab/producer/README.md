...
3. Send your message
* To test your implementation you can run `producer.py`. It will import your newly created class from the source file `producer_sol.py`
