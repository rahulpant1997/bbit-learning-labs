...
- Your class should [inherit](../../resources/python_basics.md#creating-an-interface) from our mqConsumerInterface.
- Constructor:[Save the two variables](../../resources/python_basics.md#saving-a-instance-variable-and-calling-the-variable) needed to instantiate the class.
...
* The login URL for the management web application will be http://localhost:30439/
