...
* Producer Service File
    - Implement Logic to [read from the command line](../resources/python_basics.md#reading-from-command-line-using-sys) the ticker, price and sector string and save them as variables: ticker, price, sector.
...
* Consumer Service File
    - Implement Logic to [read from the command line](../resources/python_basics.md#reading-from-command-line-using-sys) the sector and queue name string and save them as variables: sector, queueName.
...
3. Each contributor should then [git push](../resources/git_commands.md#commands-youll-need-for-today) their solutions to the fork.
...
Prerequisite knowledge and helpful references:
- [functions.md](../resources/functions.md) - RabbitMQ functions and code examples
- [python_basics.md](../resources/python_basics.md) - Python fundamentals including classes, inheritance, and command-line arguments
- [git_commands.md](../resources/git_commands.md) - Git commands for collaboration
- [rabbitmq.md](../resources/rabbitmq.md) - RabbitMQ concepts and messaging patterns
- [finance.md](../resources/finance.md) - Basic financial concepts (stocks, tickers, sectors)