...
def main(
    ticker: str, price: float, sector: str  # pylint: disable=unused-argument
) -> None:
    ...
    producer = mqProducer(
        routing_key=routing_key,  # pylint: disable=undefined-variable
    ...
    producer.publishOrder(message)  # pylint: disable=undefined-variable
...
if __name__ == "__main__":
    ...
    sys.exit(main(ticker, price, sector))  # pylint: disable=undefined-variable
