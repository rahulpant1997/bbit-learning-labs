...
The idea of this lab is to offer exposure to the RabbitMQ messaging framework, providing a basic understanding of the technology and the producer consumer relationship. During the lab you will apply your learning to create small system to setup information update on securities on interset.
...
For this project, we're going to leverage the use of Docker to create a helpful development environment for all of the engineers. [Docker](https://docs.docker.com/desktop/) is a tool used to integrate software dependencies and allow developers to quickly spin up software builds, which we will be doing in this lab. Here are the steps to check that the environment is running correctly:

1. Confirm that Docker and Docker Compose are working on your system
* `docker -v && docker-compose -v`
* If this works correctly, you will have the versions of Docker and Docker Compose printed to the terminal
2. Use Docker to create and run a working image of the project
* `docker-compose up`
* If you encounter an error such as `unix:///Users/rforrester3/.docker/run/docker.sock. Is the docker daemon running?`, please ensure that your Docker application is running
3. Log Into the RabbitMQ website.
* From your desktop, open Docker Desktop Dashboard.
* Find the Rabbitmq container and click on the URL under Port(s) (This should open up the RabbitMQ website on your default browser).
